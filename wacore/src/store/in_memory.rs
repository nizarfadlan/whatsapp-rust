...
pub struct InMemoryBackend {
    ...
    /// Count of `put_sender_keys_batch` calls. Test hook: lets lease-boundary
    /// tests distinguish forced persistence from covered sender-key advances.
    #[cfg(any(test, feature = "test-util"))]
